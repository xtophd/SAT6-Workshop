...
export ADDR_BASTION=""
export ADDR_SATELLITE=""
export ADDR_NODE1=""
export ADDR_NODE2=""
export ADDR_NODE3=""
export ADDR_NODE4=""
export BMC_BASTION=""
export BMC_SATELLITE=""
export BMC_NODE1=""
export BMC_NODE2=""
export BMC_NODE3=""
export BMC_NODE4=""
...
export BMC_PW_SATELLITE=""
export BMC_PW_NODE1=""
export BMC_PW_NODE2=""
export BMC_PW_NODE3=""
export BMC_PW_NODE4=""
export MAC_BASTION=""
export MAC_SATELLITE=""
export MAC_NODE1=""
export MAC_NODE2=""
export MAC_NODE3=""
export MAC_NODE4=""
...
export NAME_SATELLITE="satellite"
...
cat > ./config/sat6-workshop-setup.ans <<EO_ANSWERS
...
current_settings () {
    ...
    echo "Vault SAT     UID/PW ... ${SATELLITE_UID} / ${SATELLITE_PW:+"**********"}" 
    ...
    echo "Satellite: ${ADDR_SATELLITE} / ${MAC_SATELLITE} / ${HW_SATELLITE} / ${BMC_SATELLITE} / ${NAME_SATELLITE}"
...
prepare_deployment () {
    ...
    ansible-playbook sample-configs/sat6-workshop-setup.yml
...
node_menu () {
    ...
    select action in "Bastion" "Satellite" "Node1" "Node2" "Node3" "Node4" "Back to Main Menu"
    do
      case ${action}  in
        "Bastion")
...
vault_menu () {
    ...
    select action in "Set Ansible Vault Password" "Set RHSM UID" "Set RHSM Password" "Set SATELLITE UID" "Set SATELLITE Password" "Set vHost Password" "Set oVirt Password" "Set Default BMC Password" "Back to Main Menu"
    do
      case ${action}  in
        ...
        "Set SATELLITE UID")
          read -p "Enter Red Hat Subscription Manager User ID [${SATELLITE_UID}]: " input
          SATELLITE_UID=${input:-$SATELLITE_UID}
          ;;

        "Set SATELLITE Password")
          echo "Enter new password and press Enter"
          read -s -p "Enter Satellite password [${SATELLITE_PW:+"**********"}]: " input
          echo ""
          read -s -p "Enter Satellite password again [${SATELLITE_PW:+"**********"}]: " input2
          echo ""
          echo ""

          if [[ "$input" == "$input2" ]]; then
            SATELLITE_PW=${input:-$SATELLITE_PW}
          else
            echo "WARNING: Passwords do not match ... unchanged"
          fi
          ;;
...
satellite_menu () {
    ...
    do
      case ${action}  in
        ...
        "Set Version")
           select SATELLITE_VERSION in "6.12" "6.11" "6.10" "6.9" "6.8" "6.7" "6.6"
           do
