...
So a high-level summary goes like this:
  ...
  * the module is deployed to a client
  * the client executes the module and configures the client as declared by the module
