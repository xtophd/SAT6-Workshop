...
NOTE: DO NOT perform these steps unless you are certain that you have sufficient time and network bandwidth.  Enabling these additional repos will delay your ability to proceed with exercises.
